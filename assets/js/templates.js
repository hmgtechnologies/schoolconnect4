  ...
  guideHTML(moduleId, mod) {
    ...
    return `<div class="card" style="margin-bottom:16px;background:#eef2ff;border-color:#c7d2fe">
      ...
      <div id="pg-more" style="display:none;margin-top:10px">
        ...
        <p style="margin:10px 0 0;font-size:.85rem;color:var(--gray-500)">Tip: click the <strong>ℹ️ Help</strong> button in the top bar, or the 💬 assistant, for more guidance on any page.</p>
      </div></div>`;
  },
